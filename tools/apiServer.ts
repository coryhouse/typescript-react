...
server.use((req: Request, res: Response, next: Function) => {
  if (req.method === "POST") {
    // Using syntax below because typing for Request doesn't include body, because that's part of body parser: https://stackoverflow.com/questions/44325366/property-body-does-not-exist-on-type-request
...
server.post("/courses/", function(req: Request, res: Response, next: Function) {
